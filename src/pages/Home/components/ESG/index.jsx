...
const SLIDES = [
  ...
  [
    ...
    },
    {
      ...
      suffix: " lbs+",
      desc: [
        '노스페이스는 "Clothes the Loop"와 리뉴드 프로그램을 통해',
        "연간 10만 파운드 이상 의류와 신발을 수거·재사용하는 것을",
        "목표로 운영해 왔습니다.",
        "",
        "이 프로그램을 통해 매립으로 향하던",
        "텍스타일 폐기물의 상당 부분이 재사용·리사이클링됩니다.",
      ],
      image: img2 ,
      overlay: "dark",
    },
  ...
  [
    {
      ...
      suffix: "년",
      desc: [
        "노스페이스는 2025년까지 자사 포장에서",
        "모든 일회용 플라스틱을 제거하는 것을 목표로 하고 있습니다.",
        "",
  ...
  [
    ...
    },
    {
      ...
      suffix: "+ partners",
      desc: [
        "노스페이스는 보호 단체, 산악·환경 비영리, 커뮤니티 단체 등" ,
        "50개 이상 파트너와 협력해",
    ...
    },
    {
      ...
      suffix: "%+ materials",
      desc: [
        "노스페이스는 Exploration Without Compromise 배지를 통해",
        "소비자가 지속가능성이 높은 제품을",
        "쉽게 구분할 수 있도록 하고 있습니다.",
        "",
        "제품 중량 기준 75% 이상이 재활용 소재, 재생농업 기반 소재",
        "또는 책임 조달된 재생 가능 소재로 구성된 경우",
        "해당 배지를 부여합니다.",
      ],
      image:
        img9 ,
